...
## Corpus Check
- 32 files · ~12,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 282 nodes · 421 edges · 19 communities (13 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `728ac5cb`
...
Cohesion: 0.08
Nodes (27): ChartItem, MeterSegment, styles, TuiBarChart(), TuiBarChartProps, TuiProgressMeter(), TuiProgressMeterProps, TuiSegmentedMeter() (+19 more)
...
Cohesion: 0.08
Nodes (45): styles, TuiButton(), TuiButtonProps, styles, TuiCheckbox(), TuiCheckboxProps, styles, TuiContainer() (+37 more)

## Knowledge Gaps
- **175 isolated node(s):** `name`, `identifier`, `apps`, `name`, `slug` (+170 more)
